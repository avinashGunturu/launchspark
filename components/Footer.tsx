          ...
          <div className="md:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/privacy-policy" className="text-muted hover:text-primary">Privacy Policy</Link></li>
              </ul>
            </div>
            <div className="col-span-2 md:col-span-1">
              <h4 className="text-foreground font-bold mb-4">Connect</h4>
              <ul className="space-y-2 text-muted">
                <li><a href="mailto:launchspark.in@gmail.com" className="hover:text-primary">launchspark.in@gmail.com</a></li>
                <li><a href="tel:+919381365400" className="hover:text-primary">+91 9381365400</a></li>
              </ul>
            </div>
          </div>
        </div>
